...
//
//        // For forward iteration over the collection elements we can use
//        // hasNext() and next() methods of ListIterator
//        System.out.println("Forward iteration :");
//        while (it.hasNext())
//            System.out.println(it.next());
//
//        // For backward iteration over the collection elements we can use
//        // hasPrevious() and previous() methods of ListIterator
//        System.out.println("Backward iteration :");
//        while (it.hasPrevious())
//            System.out.println(it.previous());
//
//        // nextIndex and previousIndex return next and previous index from the
...
//        System.out.println("Next element is : " + it.next());
//
//        // void remove() method removes the last element returned by next or
//        // previous methods
//        it.remove();
//

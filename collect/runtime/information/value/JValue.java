...
//    protected static JExtractVisitor extractVisitor = new JExtractVisitorImplement();
    ...
    /**
     * In some cases, the name of element in array, set, list and map, the name is different from field.name().
     * @param name
     * @param field
     */
...
//    public abstract Condition getCondition();
     ...
     * @return null/not_null if is reference type object, real value as string if is primitive type object.
     */
    public abstract String getRealValueAsString();
    /**
     * 
     * @param currentField
     * @param fieldName while this is an element of array,list,map,set, fieldName is different with currentField.name()
     * @param fieldType
     * @param fieldValue
     * @param fatherObj
     * @return
     */
    protected static JValue createFieldValue(Field currentField, String fieldName, Type fieldType, Value fieldValue, JValue fatherObj){
